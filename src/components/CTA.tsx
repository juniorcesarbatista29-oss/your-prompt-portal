...
export const CTA = () => (
  ...
  >
    ...
    <div className="container mx-auto relative px-4 flex flex-col items-center text-center max-w-4xl">
      ...
      <h2 className="font-display text-4xl xs:text-5xl sm:text-6xl md:text-8xl uppercase mt-4 md:mt-6 leading-[0.95] sm:leading-[0.9] text-balance">
        Sua próxima jornada
      ...
      <p className="mt-5 md:mt-7 max-w-xl opacity-85 text-base md:text-lg">
      ...
      <Button
        asChild
        size="xl"
        className="mt-8 md:mt-10 bg-foreground text-background hover:bg-background hover:text-foreground transition-all uppercase tracking-widest font-semibold w-full sm:w-auto"
      >
        <a
