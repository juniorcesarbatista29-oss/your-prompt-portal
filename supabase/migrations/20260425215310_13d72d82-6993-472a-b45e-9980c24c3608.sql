-- Trigger: promove o PRIMEIRO usuário cadastrado a admin automaticamente.
-- Depois que existir 1 admin, novos cadastros não recebem nenhum papel automaticamente.
